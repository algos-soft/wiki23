...
public class NotaBackendTest extends AlgosTest {
    ...
    private Nota entityBean;


    private List<Nota> listaBeans;
    ...
    void findAll() {
        ...
        message = String.format("Ci sono in totale %s entities di %s", textService.format(listaBeans.size()), "Nota");
        System.out.println(message);
    }
    ...
    void printBeans(List<Nota> listaBeans) {
        System.out.println(VUOTA);
        int k = 0;

        for (Nota bean : listaBeans) {
            System.out.print(++k);
